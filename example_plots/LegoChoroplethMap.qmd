...
First steps of the data preparation are: - create a grid over the map area, which will then be the boundaries of the bricks ; - extract the centroid of each cell, which will then be the center of the brick.
